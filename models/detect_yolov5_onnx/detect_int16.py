...
if __name__ == '__main__':
    ...
    rknn.config(batch_size=1, mean_values=[[0.0, 0.0, 0.0]], std_values=[[255, 255, 255]], 
                ...
                reorder_channel='0 1 2',  # '0 1 2' : RGB, '2 1 0' : BGR
    ...
    print('done')
    deploy = sys.argv[1]
    rknn_model = deploy.replace('.onnx', '_fp16.rknn')
    ...
    size_data_map = {320:'./dataset_320.txt',
                     640:'./dataset_640.txt'}
    ret = rknn.build(do_quantization=True, dataset=size_data_map[input_size])
